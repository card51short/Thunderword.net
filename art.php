<html>
    ...
    <body>
		<article>
                <h1>DeLillo has a cold vision of the future</h1>
				
                <img class="frontPageArticle tallPic" src="images/mainArtArticle.png">
				<h3>By Michael Muench - Staff Reporter</h3>
                <p>
					<?php
